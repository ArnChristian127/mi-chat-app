        ...
        <>
            ...
            <nav className="bg-white px-2 py-1 md:hidden">
                <div className="container mx-auto flex justify-between items-center gap-2 text-pink-300 text-sm">
                    <button className="flex flex-col gap-1 items-center hover:bg-pink-300 hover:text-white px-2 py-2 rounded-xl" onClick={() => navigate("/threads")}>
                    ...
                    <button className="flex flex-col gap-1 items-center hover:bg-pink-300 hover:text-white px-2 py-2 rounded-xl" onClick={() => navigate("/chatroom")}>
                    ...
                    <button className="flex flex-col gap-1 items-center hover:bg-pink-300 hover:text-white px-2 py-2 rounded-xl" onClick={() => navigate("/about")}>
