...
export default function Authentication() {
    ...
    const handlerForm = async (e) => {
        ...
        try {
            ...
            if (flag) {
                setRegisterSuccess(<RegisterSuccess show={isRegisterSuccess} onClose={() => setRegisterSuccess(false)} />);
            }
        }
        catch (err) {
            setError(
        ...
        <>
            ...
            <div className="bg-pink-200 min-h-screen flex flex-wrap justify-center items-center px-6 py-6 gap-10">
                <div className="flex items-center flex-col gap-2">
                    ...
                    <h1 className="font-bold text-5xl text-gray-400">
            ...
            <footer className="bg-gray-600 p-5 text-center text-white">
                <h1 className="text-base sm:text-sm md:text-md lg:text-lg">&copy;{new Date().getFullYear()} ArnDev. All rights reserved.</h1>
